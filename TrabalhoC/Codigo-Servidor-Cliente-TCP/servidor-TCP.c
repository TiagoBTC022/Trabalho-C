...
int main(int argc, char **argv)
{
    ...
    // Cria um socket local para o servidor
    ...
    printf("aguardando alguma conexao...\n"); // Indica que o servidor está esperando por uma conexão
    ...
    printf("conexao estabelecida com %s\n", inet_ntoa(remote_address.sin_addr)); // Confirma a conexão
    printf("aguardando mensagens...\n"); // Indica que está pronto para receber mensagens
    do
    {
